  ...
  const restaurants = await Promise.all([
    prisma.restaurant.create({
      data: {
        ...
        nameJp: "キムチチゲ専門店",
        nameCn: "泡菜汤专门店",
        areas: JSON.stringify(['GANGNAM', 'MYEONGDONG']),
        category: 'KOREAN',
    ...
    prisma.restaurant.create({
      data: {
        ...
        nameJp: "プルコギ丼屋",
        nameCn: "烤肉盖饭店",
        areas: JSON.stringify(['GANGNAM', 'HONGDAE']),
        category: 'KOREAN',
    ...
    prisma.restaurant.create({
      data: {
        ...
        nameJp: "ヤンニョムチキン専門店",
        nameCn: "调味炸鸡专门店",
        areas: JSON.stringify(['HONGDAE', 'MYEONGDONG']),
        category: 'CHICKEN',
    ...
    prisma.restaurant.create({
      data: {
        ...
        nameJp: "トッポッキ屋台",
        nameCn: "炒年糕摊",
        areas: JSON.stringify(['GANGNAM', 'HONGDAE', 'MYEONGDONG']),
        category: 'BUNSIK',
        image: 'https://images.unsplash.com/photo-1590301157890-4810ed352733?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
        minOrderAmount: 8000,
        isActive: true
    ...
    prisma.restaurant.create({
      data: {
        ...
        nameJp: "日本ラーメン店",
        nameCn: "日式拉面店",
        areas: JSON.stringify(['GANGNAM', 'ITAEWON']),
        category: 'ASIAN',
